...
public record OptionWorths(ImmutableDictionary<string, OptionWorth> Worths)
{
...
public class OptionWorthsEventProcessor : EventProcessor<OptionWorths>
{
    public override OptionWorths Start { get; } = OptionWorths.Empty;
