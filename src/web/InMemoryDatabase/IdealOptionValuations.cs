...
public class IdealValuationsEventProcessor : EventProcessor<IdealOptionValuations>
{
    ...
    protected override IdealOptionValuations ConvEnter(IdealOptionValuations model, IHistoricContext historicContext,
        ConvEnter e)
    {
    ...
    protected override IdealOptionValuations ConvInvest(IdealOptionValuations model, IHistoricContext historicContext,
        ConvInvest e)
    {
